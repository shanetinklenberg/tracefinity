...
async def upload_image(
    ...
    inherit_webhook_url = existing.webhook_url if session_id else None
    inherit_webhook_metadata = existing.webhook_metadata if session_id else None
    ...
    user_sessions.set(session_id, Session(
        ...
        webhook_url=webhook_url or inherit_webhook_url,
        webhook_metadata=parsed_metadata or inherit_webhook_metadata,
    ))
